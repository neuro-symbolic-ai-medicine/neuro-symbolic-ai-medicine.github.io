...
        {% include figure.liquid loading="eager" path="assets/img/meetups/eu-cerebra-ai.jpg" title=" CEREBRA-AI project application" class="img-fluid rounded z-depth-1" %}
...
\### Summary — CEREBRA-AI: Towards Trustworthy General-Purpose AI for Healthcare
