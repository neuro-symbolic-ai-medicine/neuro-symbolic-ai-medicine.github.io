...
img: assets/img/meetups/ChatGPT_primary_lymphoedema.png
importance: 1
category: Projects
...
<div class="row">
	<div class="col-sm mt-3 mt-md-0">
       {% include figure.liquid loading="eager" path="assets/img/meetups/lymphoscintigrams.jpg" title="Lymphoscintigrams" class="img-fluid rounded z-depth-1" %}
   </div>
</div>
